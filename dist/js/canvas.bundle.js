...
function Particle(x, y, radius, color) {
    ...
    this.update = function () {
        ...
        // drag effect
        _this.lastMouse += (mouse.x - _this.lastMouse.x) * 0.05;

        // circular motion
        _this.x = mouse.x + Math.cos(_this.radians) * _this.distance.x;
        _this.y = mouse.y + Math.sin(_this.radians) * _this.distance.x;
